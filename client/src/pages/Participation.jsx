    ...
    <div className={embedded ? '' : 'mt-4'}>
      <Card>
                  ...
                  <tr key={r.id}>
                    ...
                    <td className="py-2.5 pr-3 text-right tabular-nums text-navy">
                      ...
                      <div className="text-[10px] text-navy-400">
                        {r.attendance.present + r.attendance.excused}/
                        {r.attendance.total}
                      </div>
                    </td>
                    <td className="py-2.5 pr-3 text-right tabular-nums text-navy">
        ...
        <div className="mt-4 flex items-start gap-2 rounded-lg bg-navy-50 px-3 py-2 text-[11px] text-navy-400">
          ...
          <div>
            Attendance counts both <em>Present</em> and <em>Excused</em>.
            Pitches come from the presenter table (assignments), capped at{' '}
            {weights.pitchCap} for score purposes. Advisory / Faculty roles
