...
// Identical copy lives at server/src/lib/lunchSlots.js — keep them in
...
// Uses UTC accessors so a "2026-04-29" string from a <input type="date">
// always resolves to Wednesday regardless of the caller's local timezone
// (the input parses as UTC midnight; in ET that's 8 PM the day before,
// which would otherwise flip the weekday).
